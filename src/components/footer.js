...
import UpsideDownDarkClouds from "../assets/dark-clouds-upsidedown.svg";

const Footer = () => (
  <footer className="footer">
    <UpsideDownDarkClouds className="footer__clouds" />
    <div className="footer__contact">
      <p>
        👷🏼‍♂️ in development by Felipe Brunetti - "I'm currently{" "}
        <b>open to work</b> if you find me a good fit please contact me"
      </p>
      <div className="footer__links">
        ...
        <a href="https://github.com/felipebrunetti94" className="footer__icon">
          <svg
            viewBox="0 0 24 24"
            fill="none"
            xmlns="http://www.w3.org/2000/svg"
